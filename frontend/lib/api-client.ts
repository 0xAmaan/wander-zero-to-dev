...
// Defaults favor Docker Compose (localhost:8080)
// For Kubernetes, set env vars via .env.local (auto-generated by Makefile)
const API_URL =
  typeof window === "undefined"
    ? process.env.API_URL_INTERNAL || "http://localhost:8080" // Server-side (defaults to localhost for Docker Compose)
    : process.env.NEXT_PUBLIC_API_URL || "http://localhost:8080"; // Client-side (defaults to localhost for Docker Compose)
